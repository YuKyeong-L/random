...
function randomMenu() {
  ...
  var shopList = [
    {
      name: "일번지식당",
      link: "http://kko.to/0Er-9QITd5",
      key: ["백반", "칼국수", "잔치국수", "제육"],
    },
    { name: "씬머이", link: "http://kko.to/b_qros1pBj", key: ["쌀국수"] },
    {
      name: "고소미부엌",
      link: "http://kko.to/AukTyBJyL8",
      key: ["김밥", "떡볶이"],
    },
    {
      name: "샐러디 태릉입구역점",
      link: "http://kko.to/5BqBxKK0ZT",
      key: ["샐러드", "샌드위치"],
    },
    { name: "수카츠", link: "http://kko.to/fj4x_MiMN9", key: ["돈까스"] },
    {
      name: "맘스터치 태릉입구역점",
      link: "http://kko.to/Guy6XZrhVm",
      key: ["햄버거"],
    },
    {
      name: "고윤김밥",
      link: "http://kko.to/FlpF3vnmSp",
      key: ["김밥", "돈까스", "라면", "제육"],
    },
    { name: "이츠초밥", link: "http://kko.to/axNnJqN0Lt", key: ["초밥"] },
    {
      name: "국수잔치",
      link: "http://kko.to/axNnJqN0Lt",
      key: ["잔치국수", "제육"],
    },
  ];
  ...
  for (i = 0; i < shopList.length; i++) {
    if (shopList[i].key.includes(menuName.innerText)) {
      ...
      list.innerHTML = `<div class="shop-info">
